 ...
 * generated in the jaxwsGenerated package.
...
public class ObjectFactory {
    ...
    private final static QName _GcdSumResponse_QNAME = new QName("http://jaxws.services.java.main/", "gcdSumResponse");
    private final static QName _GcdList_QNAME = new QName("http://jaxws.services.java.main/", "gcdList");
    private final static QName _GcdListResponse_QNAME = new QName("http://jaxws.services.java.main/", "gcdListResponse");
    private final static QName _GcdSum_QNAME = new QName("http://jaxws.services.java.main/", "gcdSum");
    private final static QName _Gcd_QNAME = new QName("http://jaxws.services.java.main/", "gcd");
    private final static QName _GcdResponse_QNAME = new QName("http://jaxws.services.java.main/", "gcdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jaxwsGenerated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.services.java.main/", name = "gcdSumResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.services.java.main/", name = "gcdList")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.services.java.main/", name = "gcdListResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.services.java.main/", name = "gcdSum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.services.java.main/", name = "gcd")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.services.java.main/", name = "gcdResponse")
